...
The model behind it: Elo → Dixon–Coles bivariate Poisson, Shin-devigged betting markets, an explicit model of the opponent field, and a leverage-based picker that maximizes P(top 3) instead of expected points. The full write-up is on the [Theory page](https://tlifschitz.github.io/tobis-wc2026-picks/theory.html).
